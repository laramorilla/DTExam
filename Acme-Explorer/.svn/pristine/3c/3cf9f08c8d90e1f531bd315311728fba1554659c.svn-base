...
<form:form action="auditor/admin/register.do" modelAttribute="auditor" onsubmit="return validateForm()">
	...
	<input type="submit" name="cancel" value="<spring:message code="auditor.cancel" />" />
