...
public class StoryServiceTest extends AbstractTest {
	...
	@Test
	public void testAssignStoryToTrip() {
		...
		// Modificamos los atributos de story

		attachments = new ArrayList<String>();
		attachments.add("http://www.attachmentModified.com");
		...
		Assert.isTrue(!trip.getStories().contains(saved));

		this.storyService.assignStoryToTrip(saved, trip);
		Assert.isTrue(trip.getStories().contains(saved));
